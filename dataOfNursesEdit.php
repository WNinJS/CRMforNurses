...
<head>
    ...
    <title> Редактирование данных сиделок </title>
</head>
<body>
    <!-- ШАПКА -->
    ...
    <div class="container-fluid d-flex justify-content-center h-100 mx-0">
        <div class="row h-100 w-100">
            ...
            <div class="col-12 h-100 text-center d-flex flex-column align-items-center">
                <h2 class="titleText text-center"> РЕДАКТИРОВАНИЕ ДАННЫХ О СИДЕЛКАХ </h2>
                
                <br>
                <hr class="hr-white">
                <form class="find" method="POST d-flex justify-content-around">
                    <input type="text" class="find-input" placeholder="Введите ФИО или возраст или телефон или национальность и т.п.">

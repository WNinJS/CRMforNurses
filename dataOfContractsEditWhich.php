...
<head>
    ...
    <title> Редактирование данных договора </title>
</head>
<body>
    <!-- ШАПКА -->
            ...
            <div class="col-12 h-100 text-center d-flex flex-column align-items-center">
                ...
                <form method="POST" class="formSize d-flex flex-column align-items-center text-center">
                    ...
                    <div class="footer d-flex justify-content-center">
                        <button type="submit" style="margin-bottom: 20px;" class="btn btn-light-nurses-main"> РЕДАКТИРОВАТЬ </button>
                    </div>
                </form>
                <button class="btn btn-light-nurses-main" data-toggle="modal" data-target="#payBack"> ВОЗВРАТ НЕОТРАБОТАННОЙ СУММЫ </button>
                <br>
            </div>
        </div>
    </div>
...
<!-- Модальное окно возврата оплаты -->
<div class="modal fade" id="payBack" tabindex="-1" role="dialog" aria-labelledby="payBackLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="payBackLabel">ВОЗВРАТ ОПЛАТЫ ЗА ДОГОВОР</h5>
      ...
      <div class="modal-footer d-flex justify-content-center">
        <button type="button" class="btn btn-primary-modal">ВОЗВРАТИТЬ</button>
      </div>
    </div>
  </div>
</div>

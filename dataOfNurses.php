        ...
        <div class="row h-100 w-100">
            ...
            <div class="col-12 h-100 text-center d-flex flex-column align-items-center">
                <div class="d-flex flex-row justify-content-center">
                    <button class="btn btn-light-nurses-main" onclick="goToViewNurses()">
                        <script type="text/javascript"> 
                            function goToViewNurses() 
                            { 
                                location.href = "dataOfNursesView.php" 
                            }; 
                        </script> 
                        ПРОСМОТРЕТЬ
                    </button>
                ...
                <div class="d-flex flex-row justify-content-center">
                    ...
                    <button class="btn btn-light-nurses-main" onclick="goToAddNurses()">
                        <script type="text/javascript">
                            function goToAddNurses()
                            {
                                location.href="dataOfNursesAdd.php"
                            }
                        </script>
                        ДОБАВИТЬ
                    </button>
                ...
                <div class="d-flex flex-row justify-content-center">
                    <button class="btn btn-light-nurses-main" onclick="goToEditNurses()">
                        <script type="text/javascript">
                            function goToEditNurses() 
                            { 
                                location.href = "dataOfNursesEdit.php" 
                            }; 
                        </script> 
                        РЕДАКТИРОВАТЬ
                    </button>

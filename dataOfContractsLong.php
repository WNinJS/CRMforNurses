...
<head>
    ...
    <title> Пролонгрование договоров </title>
</head>
<body>
     <!-- ШАПКА -->
    ...
    <div class="container-fluid d-flex justify-content-center h-100 mx-0">
        <div class="row h-100 w-100">
            ...
            <div class="col-12 h-100 text-center d-flex flex-column align-items-center">
                <h2 class="titleText text-center"> ПРОЛОНГИРОВАНИЕ ДОГОВОРОВ </h2>
                ...
                <div class="d-flex flex-column align-items-center">
                    <a class="name-of-nurses" href="dataOfContractsLongWhich.php"> ДОГОВОР №1 </a>
                </div>
